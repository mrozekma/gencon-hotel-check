...
This was most recently updated for Gencon 2018. If it's currently a later year, I'll probably be putting out an update soon after housing opens. If that doesn't happen, you can probably figure out [what to edit](https://github.com/mrozekma/gencon-hotel-check/blob/master/gencon-hotel-check.py#L16-L17) to get it working assuming nothing major has changed on the housing website.
